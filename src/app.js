  ...
  for (let i = 1; i <= amount.value; i++) {
    ...
    if (palos[indexPalo] == "♥" || palos[indexPalo] == "♦") {
      document.getElementById(
        "tablero"
      ).innerHTML += `<div class="card d-flex p-1 m-3 border border-secondary" style="width: 190px; height: 15rem; justify-content: space-between; border-radius: 15px;  font-size: 40px; margin: 5px;">
